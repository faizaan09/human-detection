...
% 0.001  0.7574
C = 0.0005;
[clf, obj_vals,APs] = hard_negative_mining(utils,trD,trLb,valD,valLb,10,C)

function [clf,obj_vals,avg_precs] = hard_negative_mining(utils,x_train,y_train,x_val,y_val,max_epoch,C)
    clf = KernelSVM([],[]);
%     C = 10;
